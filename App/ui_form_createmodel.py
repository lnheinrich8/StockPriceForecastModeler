...
class Ui_CreateModel(object):
    def setupUi(self, CreateModel):
        ...
        self.restore_button.setGeometry(QRect(150, 39, 111, 22))
        ...
        self.layoutWidget2.setGeometry(QRect(450, 100, 88, 27))
        ...
        self.layoutWidget3.setGeometry(QRect(450, 180, 121, 27))
        ...
        self.layoutWidget6.setGeometry(QRect(450, 220, 78, 27))
