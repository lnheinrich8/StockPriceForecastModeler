...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(20, 0, 761, 571))
        self.tabWidget.setTabShape(QTabWidget.Rounded)
        self.tab1 = QWidget()
        self.tab1.setObjectName(u"tab1")
        self.layoutWidget = QWidget(self.tab1)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(21, 23, 383, 60))
        ...
        self.currentdata_label = QLabel(self.layoutWidget)
        ...
        self.back_button = QPushButton(self.layoutWidget)
        ...
        self.window1000_button = QPushButton(self.layoutWidget1)
        ...
        self.widget.setGeometry(QRect(620, 30, 82, 78))
